      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12" data-wow-duration="2s">
            <div class="promo-text register">
			  <h2 class="text-center" style="font-weight: bold; font-size: 40px;">This is the easiest way to find the BEST credit card processor for your business!</h2>
    		</div>
          </div>
		</div>
		<div class="row" style="padding-bottom: 30px;">
          <div class="col-md-5 promo-text register" data-wow-duration="2s" style="margin: 0px 0px;">
			  <h2 class="text-center" style="font-weight: bold; font-size: 40px;">When credit card processors bid, your business wins!</h2>
          </div>
          <div class="col-md-1" data-wow-duration="2s">
          </div>
          <div class="col-md-6" data-wow-duration="2s" style="background-color: #fff;">
        ...
        <hr>
            ...
            <form>
              ...
              <div class="col-md-6">
                <div class="form-group">
                    <label for="checkbox">Do you currently accept cards?</label>
                        <div class="checkbox">
...
<div class="col-md-6">
              <div class="form-group">
                  <label for="checkbox">Will you accept Amex & Discover?</label>
                      <div class="checkbox">
                          <label><input type="checkbox" value="discover"> <img src="img/disc.png"></label>
                      </div>
                      <div class="checkbox">
                          <label><input type="checkbox" value="amex"> <img src="img/amex.png"></label>
                      </div>
              </div> </div>
    <div class="col-md-6">
              <div class="form-group">
                <label>Average Monthly Credit Card Processing?</label>
                  <input type="MCCP" value="$" class="form-control" id="MCCP">
              </div>
 </div>    <div class="col-md-6">
              <div class="form-group">
                <label>Average Transaction Amount?</label>
                  <input type="TA" value="$" class="form-control" id="TA">
              </div> </div>
<div class="col-md-4">
              <div class="form-group">
                <label>In Store:</label>
                  <input type="IS" value="$" class="form-control" id="IS">
              </div>     </div>
<div class="col-md-4">
              <div class="form-group">
                <label>Online:</label>
                  <input type="Online" value="$" class="form-control" id="Online">
              </div>     </div>
<div class="col-md-4">
              <div class="form-group">
                <label>Hand-key:</label>
                  <input type="Hand" value="$" class="form-control" id="Hand-key">
              </div>
     </div>
            </form>
      ...
      <div class="container">
        ...
        <div class="row text-center">
          <div class="col-lg-12">
			...
			<!--
				<div class="col-md-3 col-sm-6" style="padding-top: 20px;">
              		<img src="/img/clarent.gif" width="250" alt="Clearent">
				</div>
			-->
				<div class="col-md-3 col-sm-6" style="padding-top: 20px;">
    ...
    <div class="charities" id="charities" style="background-color: #fff;">
      <div class="container" style="padding-bottom: 20px;">
        <div class="section-heading" style="padding-top: 20px;">
          <h1 class="text-center" style="color: #000; font-weight: bold;">Giving Back</h1>
        </div> 
        <div class="row">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="row" style="padding-top: 15px; padding-left: 15px;">
						<div class="col-md-6 col-sm-3" style="font-size: 16px;">
