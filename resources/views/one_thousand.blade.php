    ...
    display: block;
      ...
      <div class="charities" id="charities" style="background-color: #fff;">
        <div style="padding-top: 60px; padding-bottom: 60px; margin-left: 25px; margin-right: 25px;">
			<div class="row">
				<div class="col-md-8">
            		<h2 style="text-decoration: underline;font-size: 36px;">Take the $1,000 Challenge</h2>
					<h2>How it works:</h2>
					<ul style="font-size: 16px;">
						<li>Sign up & upload your current credit card statement</li>
						<li>Without sharing your contact info, we do all the complicated work of negotiating bids on your behalf to find the best rates for your business</li>
						<li>To help make this process more simple & transparent, we present you with all the bids</li> 
						<li>You choose your preferred bid and we connect you so they can help you get started!</li>
					</ul>

					<h2>Our $1K Guarantee:</h2>
					<p style="font-size: 16px;">If none of our partners can beat your current rate, we will give you $1,000!
					It’s a Win-Win! You either get $1,000 cash, or you save even way more than that with your new processor!</p>	
